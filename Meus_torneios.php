...
<body style="overflow-x: hidden;">
    ...
    <div class="table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th class="text-center">Torneios</th>
                    <th class="text-center">A decorrer</th>
                    <th class="text-center">Data início</th>
                    <th>Data final</th>
                    <th>Cidade</th>
                    <th>Equipas com vagas</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>Cell 4</td>
                    <td>Cell 5</td>
                    <td><button class="btn btn-primary" type="button">Info&nbsp;<i class="fa fa-long-arrow-right"></i></button></td>
                </tr>
            </tbody>
        </table>
    </div>
